...
import com.example.yolbelgilari.databinding.ItemVp2Binding
import kotlinx.android.synthetic.main.item_vp_2.view.*
import java.io.Serializable

class ViewPager2Adapter (val context: Context?, val rvItemClick: RvItemClick) : RecyclerView.Adapter<ViewPager2Adapter.Vh>(), Serializable {
