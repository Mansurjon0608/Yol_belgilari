...
import com.example.yolbelgilari.databinding.FragmentMyHomeBinding
...
class MyHomeFragment : Fragment() {
    ...
    lateinit var viewPager2BelgiAdapter: ViewPager2Adapter
    ...
    override fun onResume() {
        ...
        viewPager2BelgiAdapter = ViewPager2Adapter(context, object : RvItemClick {
            ...
            override fun itemClick(belgi: Belgi) {
                findNavController().navigate(R.id.infoFragment, bundleOf("keyBelgi" to belgi))
            }
        })
